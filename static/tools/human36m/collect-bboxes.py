...
dataset_root = os.path.expanduser('~/data/human36m/training/subject/')
data_path = os.path.join(dataset_root)
data_processed_path = os.path.join(dataset_root, "processed")
...
for subject in subjects:
    subject_path = os.path.join(data_processed_path, subject)
