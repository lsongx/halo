...
from vcnerf.apis import set_random_seed, train_renderer
from vcnerf.datasets import build_dataset
from vcnerf.models import build_renderer
from vcnerf.utils import collect_env, get_root_logger


def parse_args():
    parser = argparse.ArgumentParser(description='Train a detector')
    parser.add_argument('--config', default='./configs/nerf_blender.py', help='train config file path')
